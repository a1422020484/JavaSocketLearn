...
@Component
public class KaiXuanImpl implements PlatformInterface {

	static final Logger log = LoggerFactory.getLogger("kaixuan");

	final String appId = PTConfig.val("KaixuanAppId");
	final String appKey = PTConfig.val("KaixuanAppKey");
	final String appSecret = PTConfig.val("KaixuanAppSecret");
	final String verifyUrl = PTConfig.val("KaixuanVerifyUrl");
