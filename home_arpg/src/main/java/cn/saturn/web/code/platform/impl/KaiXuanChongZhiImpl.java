...
@Component
public class KaiXuanChongZhiImpl implements PlatformInterface {

	static final Logger log = LoggerFactory.getLogger("kaixuanchongzhi");

	final String appId = PTConfig.val("KaixuanChongZhiAppId");
	final String appKey = PTConfig.val("KaixuanChongZhiAppKey");
	final String appSecret = PTConfig.val("KaixuanChongZhiAppSecret");
	final String verifyUrl = PTConfig.val("KaixuanChongZhiVerifyUrl");
