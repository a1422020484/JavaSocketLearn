 ...
 */
@Component
public class YumiImpl implements PlatformInterface {
    public static final String flag = "yumi";
    public static final Logger log = LoggerFactory.getLogger(flag);
    public static final String[] params = new String[]{};

    public static final String appId = PTConfig.val("YumiAppId");
    public static final String appKey = PTConfig.val("YumiAppKey");
    public static final String url = PTConfig.val("YumiVerifyUrl");
