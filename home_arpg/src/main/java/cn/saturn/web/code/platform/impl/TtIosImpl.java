 ...
 */
@Component
public class TtIosImpl implements PlatformInterface {
	public static final String flag = "ttios";
	static final Logger log = LoggerFactory.getLogger(flag);

	String ttGameId = PTConfig.val("TtIosGameId");
	String ttSignSecretKey = PTConfig.val("TtIosSignSecretKey");
	String ttPaySecretKey = PTConfig.val("TtIosPaySecretKey");
	String ttLoginVerifyUrl = PTConfig.val("TtIosLoginVerifyUrl");
	...
	public LoginResponse login(Map<String, String> params) {
		...
		try {
			...
			if (rs.head.result.equals("0")) {
				...
				log.debug(flag + "|{}|{}", rs.head.result, rs.head.message);
