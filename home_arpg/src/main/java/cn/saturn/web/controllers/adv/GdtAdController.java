...
public class GdtAdController {
	...
	*/
	...
	public String gameLoad(@Param("games") String games,@Param("adPlatForm") String adPlatform,@Param("subPlatform") String subPlatform,
			@Param("version") String version, @Param("muid") String muid,@Param("click_time") long click_time,@Param("appid") int appid,
			@Param("click_id") String click_id, @Param("app_type") String app_type,
			@Param("advertiser_id") int advertiser_id) {
		...
		adv.setCid(String.valueOf(appid));
		
		
		
		adv.setAid(String.valueOf(advertiser_id));	
