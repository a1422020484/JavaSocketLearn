...
--%>
<%@page import="cn.saturn.web.client.H11102RespHandler"%>
...
<%
    ...
    try {
        ...
        if(server != null){
        	...
        	client.addHandler(new H11102RespHandler());
        	int playerId = bind.getPlayerId();
        	SendGMCmdWCS.Builder msgb = SendGMCmdWCS.newBuilder();
        	String cmd = "/changeItem "+playerId+" 100000002 " + params.gold;
        	msgb.setCmd(cmd);
        	try{
        		client.send(CHead.H11102, msgb.build());
        	}catch(Exception e){
        		e.printStackTrace();
