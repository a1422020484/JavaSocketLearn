...
function ajaxSub()
{
	 ...
	 var ajaxUrl = "${path}"+'/power/log/toCheck01?srvId='+srvId+"&playerText="+playerText
			 +"&type1="+type1+"&type2="+type2+"&startTime="+startTime+"&endTime="+endTime+"&mainView=true";
	 var subUrl =  "${path}"+'/power/log/toCheck?srvId='+srvId+"&playerText="+playerText
	 +"&type1="+type1+"&type2="+type2+"&startTime="+startTime+"&endTime="+endTime+"&mainView=true";
		...
		<form id="myfrom" target="_top">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<%
						//WebUtils.createSelected(pageContext, "type1", "input_select", LogController.logType.getTypes0(), 0);
					%>
					<input class="input_from" name="type1" id="type1" type="text"
						style="width: 100px;" />
						
					<input class="input_from" name="type2" id="type2" type="text"
						style="width: 100px;" />
				</div>
				<p class="help-block"></p>
			</div>
