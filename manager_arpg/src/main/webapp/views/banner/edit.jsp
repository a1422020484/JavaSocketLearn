...
<div id="body2" 
		...
		<form id="myfrom" target="_top">
			...
			<table border="1">
				<tr>
					<td style="background-color: rgb(184, 204, 228)">弹窗图配置</td>
					<td width="75%">
					弹窗图1:
					<input class="input_from" name="banner1" type="text" value="${banner1}" style="width: 180px;" /> <br>
					弹窗图2:
					<input class="input_from" name="banner2" type="text" value="${banner2}" style="width: 180px;" /> <br>
					弹窗图3:
					<input class="input_from" name="banner3" type="text" value="${banner3}" style="width: 180px;" /> <br>
					弹窗图4:
					<input class="input_from" name="banner4" type="text" value="${banner4}" style="width: 180px;" /> <br>
					</td>
				</tr>
			</table>
			<br />
