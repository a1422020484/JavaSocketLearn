...
<body>
	...
	<table id="searchTable" style="width: 98%">
		...
		<tr>
			...
			<th w_index="mailMsg" width="5%;">邮件内容</th>
			<th w_index="remark" width="5%;">备注</th>
			<th w_render="operate" width="5%;">
			<!--  <a href="javascript:void;"
				target="_top" onclick="center_iframe('${sendUrl}?mainView=true');">发送</a>&nbsp;|&nbsp--><a
				href="javascript:void;" target="_top"
				onclick="center_iframe('${addUrl}?mainView=true');">新建</a>&nbsp;|&nbsp<a
				href="javascript:void;" target="_top" onclick="center_iframe('${checkUrl}?mainView=true');">查看</a></th>
		</tr>
	</table>
