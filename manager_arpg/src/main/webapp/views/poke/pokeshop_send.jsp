...
function onSubmit()
{
	 $.messager.confirm('提醒', '是否发送扭蛋积分特卖到服务器?', function(r){
       if (r){
        	ajaxSub();
        }
     });
...
<div id="body2" style="width: 98%; margin: 0 auto; text-align: center;overflow:auto " >
	...
	<br /><br />
	<table id="dg" title="扭蛋积分特卖" style="height: 500px" 
	fitColumns="true"  data-options="rownumbers:true,singleSelect:true">
		<thead>
			<tr>
				<th data-options="field:'ck',checkbox:true"></th>
				<th field="pokeId" width="50">扭蛋积分ID</th>
				<th field="pokeDescription" width="50">扭蛋积分特卖</th>
			</tr>
		</thead>
 	</table>
	<br /> <br />
