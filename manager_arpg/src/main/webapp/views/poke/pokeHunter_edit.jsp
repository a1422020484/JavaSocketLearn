...
<body>
		...
		<div style="width: 90%; text-align: center;">
			<form id="myfrom" target="_top">
				...
				<table border="1">
					...
					<tr rowspan="2">
						<td style="background-color: rgb(184, 204, 228)" width="10%">初级狩猎场</td>
						<td style="background-color: rgb(184, 204, 228)" width="10%">热点精灵</td>
						<td align="left" width="5%">
						<input class="easyui-combobox" id="first" name="first"
								data-options="valueField:'id',textField:'name'" value="${first}">
						</td>
						<td style="background-color: rgb(184, 204, 228)" width="5%">最少保底数</td>
						<td align="left" width="5%"><input class="easyui-numberbox" style="width: 100px;" id="first_min_bd" name="first_min_bd" value="${first_min_bd}"></td>	
						<td style="background-color: rgb(184, 204, 228)" width="5%">最大保底数</td>
						<td align="left" width="5%"><input class="easyui-numberbox" style="width: 100px;"  id="first_max_bd" name="first_max_bd" value="${first_max_bd}"></td>
				...
				<table border="1">
					...
					<tr rowspan="2">
						<td style="background-color: rgb(184, 204, 228)" width="10%">中级狩猎场</td>
						<td style="background-color: rgb(184, 204, 228)" width="10%">热点精灵</td>
						<td align="left" width="5%">
						...
						<td style="background-color: rgb(184, 204, 228)" width="5%">最少保底数</td>
						<td align="left" width="5%"><input class="easyui-numberbox" style="width: 100px;" id="second_min_bd" name="second_min_bd" value="${second_min_bd}" ></td>	
						<td style="background-color: rgb(184, 204, 228)" width="5%">最大保底数</td>
						<td align="left" width="5%"><input class="easyui-numberbox"  style="width: 100px;" id="second_max_bd" name="second_max_bd"  value="${second_max_bd}"></td>
						<td align="left" width="70%"></td>
					</tr>
				</table>
				<br /> <br />
				...
				<table border="1">
					...
					<tr >
						<td style="background-color: rgb(184, 204, 228)" width="10%">高级狩猎场</td>
						<td style="background-color: rgb(184, 204, 228)" width="10%" >热点精灵</td>
						<td align="left" width="5%">
						...
						<td style="background-color: rgb(184, 204, 228)"  width="5%">最少保底数</td>
						<td align="left" width="5%"><input class="easyui-numberbox" style="width: 100px;"  id="third_min_bd" name="third_min_bd" value="${third_min_bd}" ></td>	
						<td style="background-color: rgb(184, 204, 228)"  width="5%">最大保底数</td>
						<td align="left" width="5%"><input class="easyui-numberbox" style="width: 100px;"  id="third_max_bd" name="third_max_bd" value="${third_max_bd}" ></td>
						<td align="left" width="70%"></td>
					</tr>
				</table>
				<br /> <br />
	...
	$(document).ready(function() {
		...
		$.ajax({
			type : "POST",
			url : "../PokeHunter/getSelect2EasyUi?type=1",
			datatype : "json",
			success : function(data) {
			var obj = eval(data);
			if (obj.length > 0) {
		...
		$.ajax({
			type : "POST",
			url : "../PokeHunter/getSelect2EasyUi?type=2",
			datatype : "json",
			success : function(data) {
				var obj = eval(data);
				if (obj.length > 0) {
		...
		$.ajax({
			type : "POST",
			url : "../PokeHunter/getSelect2EasyUi?type=3",
			datatype : "json",
			success : function(data) {
				var obj = eval(data);
				if (obj.length > 0) {
