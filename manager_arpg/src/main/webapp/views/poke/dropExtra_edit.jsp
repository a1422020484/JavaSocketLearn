...
<body>
		...
		<div style="width: 90%; text-align: center;">
			<form id="myfrom" target="_top">
				...
				<table border="1">
					...
					<tr rowspan="2">
						<td style="background-color: rgb(184, 204, 228)" width="10%">掉落物品查询</td>
						<td style="background-color: rgb(184, 204, 228)" width="10%">物品ID</td>
						<td align="left" width="80%">
						<input class="easyui-combobox" id="first" name="first" 
								data-options="valueField:'id',textField:'name',width:900" value="${first}">
						</td>
					</tr>
				</table>
	...
	$(document).ready(function() {
		...
		$.ajax({
			type : "POST",
			url : "../dropExtra/getSelect2EasyUi?type=1",
			datatype : "json",
			success : function(data) {
			var obj = eval(data);
			if (obj.length > 0) {
