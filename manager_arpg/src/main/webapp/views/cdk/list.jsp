...
<body>
	...
	<table id="searchTable" style="width: 98%">
		...
		<tr>
			...
			<th w_index="name" width="5%;">礼包名称</th>
			<th w_index="num" width="5%;">礼包数量</th>
			<th w_index="overTime" width="5%;">礼包过期时间</th>
			<th w_index="createTime" width="5%;">生成时间</th>
			<th w_index="cdkfile" width="5%;">文件</th>
			<th w_index="platformLimit" width="5%;">平台过滤</th>
			<th w_index="type" width="5%;">礼包类型</th>
			<th w_index="useCount" width="5%;">使用次数</th>
			<th w_index="useLimit" width="5%;">使用上限</th>
			<th w_render="operate" width="5%;">
			<a href="javascript:void;" target="_top" onclick="center_iframe('${uploadUrl}?mainView=true');">上传</a>&nbsp;|
	...
	<script type="text/javascript">
		...
		function operate(record, rowIndex, colIndex, options) {
			...
			var downloadUrl = "${toDownloadUrl}?id=" + id+"&mainView=true";

			String
			downloadStr = '<a href="javascript:void;" target="_top" onclick="center_iframe(\''
					+ downloadUrl
					+ '\');"  >下载</a>';
