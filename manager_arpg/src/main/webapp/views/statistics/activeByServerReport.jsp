...
<body>
   ...
   <thead>    
        <tr>    
            <th field="0" width="200" >服务器名称</th>
            <th field="1" width="200" >时间(小时)</th>       
            <th field="2" width="80" >当前在线</th>
            <th field="3" width="80" >昨天在线</th>    
        </tr>    
    </thead>    
    </table>
    <div id="tb" style="padding:2px 5px;">
                    区服:
        <select name="srvIds" id="srvIds" class="easyui-combobox" style="width:100px" >
	...
	function toSubmit() {
		...
		var srvIds = $('#srvIds').combobox('getValues');
		
		//console.
		// 通过 ajax 请求数据
		var urlStr = "${sendUrl}&srvIds="
				+ srvIds + "&isSelect=1";
