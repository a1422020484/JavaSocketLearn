...
<div id="body2" 
	 	style="width: 90%;height:700px margin: 0 auto; text-align: center;overflow:auto" >
	<div id="bg" class="easyui-datagrid" title="" style="width:100%;height:500px"
    	...
    	<div id="tb" style="padding:2px 5px;">
     	...
     	区服:
        <select name="srvId" id="srvId"  class="easyui-combobox"  overflow="auto;"  style="width:150px;">
