	...
	<table id="bg" class="easyui-datagrid" title="" style="width:100%;height:500px" 
        ...
        <thead>
           <tr>
            	<th colspan="1">日期</th>
            	<th colspan="2">总计</th>
                <th colspan="2">矿石购买</th>
                <th colspan="2">vip商店</th>
                <th colspan="2">黑市商店</th>
                <th colspan="2">冒险者商店</th>
                <th colspan="2">活动领取</th>
                <th colspan="2">邮件获得</th>
                <th colspan="2">掠夺</th>
                <th colspan="2">矿洞产出</th>
                <th colspan="2">冒险副本</th>
            </tr>
            <tr>
            	<th data-options="field:'0',width:100">日期</th>	
                <th data-options="field:'1',width:50">次数</th>
                <th data-options="field:'2',width:50">辉晶矿</th>
                <th data-options="field:'3',width:50">次数</th>
                <th data-options="field:'4',width:50">辉晶矿</th>
                <th data-options="field:'5',width:50">次数</th>
                <th data-options="field:'6',width:50">辉晶矿</th>
                <th data-options="field:'7',width:50">次数</th>
                <th data-options="field:'8',width:50">辉晶矿</th>
                <th data-options="field:'9',width:50">次数</th>
                <th data-options="field:'10',width:50">辉晶矿</th>
                <th data-options="field:'11',width:50">次数</th>
                <th data-options="field:'12',width:50">辉晶矿</th>
                <th data-options="field:'13',width:50">次数</th>
                <th data-options="field:'14',width:50">辉晶矿</th>
                <th data-options="field:'15',width:50">次数</th>
                <th data-options="field:'16',width:50">辉晶矿</th>
                <th data-options="field:'17',width:50">次数</th>
                <th data-options="field:'18',width:50">辉晶矿</th>
                <th data-options="field:'19',width:50">次数</th>
                <th data-options="field:'20',width:50">辉晶矿</th>
            </tr>
        </thead>
    </table>
