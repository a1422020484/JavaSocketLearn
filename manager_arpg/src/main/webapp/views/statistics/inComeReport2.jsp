...
<script type="text/javascript">
	function toCheck(startTime) {
		var channelId = $('#channelId option:selected').attr("id");
		var retStr = callJava("${sendUrl}&channelId=" + channelId +"&startTime=" + startTime + "&isSelect=1");
...
<body>
    ...
    <div id="tb" style="padding:2px 5px;">
    	...
    	<select name="channelId" id="channelId" class="easyui-combobox"  style="width:100px">
       	...
       	时间:<input class="easyui-datebox" name="startTime" id="startTime" value="${dayTime}" data-options="formatter:myformatter,parser:myparser">       
	...
	function toSubmit() {
		...
		// 通过 ajax 请求数据
		var urlStr = "${sendUrl}&channelId=" + channelId + "&startTime=" + startTime + "&isSelect=1";
