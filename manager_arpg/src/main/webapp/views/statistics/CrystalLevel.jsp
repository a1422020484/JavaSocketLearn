	...
	<table id="bg" class="easyui-datagrid" title="" style="width:100%;height:500px" 
        ...
        <thead>
            <tr>
            	<th colspan="1">日期</th>
                <th colspan="3">总计</th>
                <th colspan="3">1~10级</th>
                <th colspan="3">11~20级</th>
                <th colspan="3">21~30级</th>
                <th colspan="3">31~40级</th>
                <th colspan="3">41~50级</th>
                <th colspan="3">51~60级</th>
                <th colspan="3">61~70级</th>
                <th colspan="3">71~80级</th>
                <th colspan="3">81级以上(含81)</th>
            </tr>
            <tr>
            	<th data-options="field:'0'">日期</th>	
                <th data-options="field:'1'">消耗</th>
                <th data-options="field:'2'">总产出</th>
                <th data-options="field:'3'">留存</th>
                <th data-options="field:'4'">消耗</th>
                <th data-options="field:'5'">总产出</th>
                <th data-options="field:'6'">留存</th>
                <th data-options="field:'7'">消耗</th>
                <th data-options="field:'8'">总产出</th>
                <th data-options="field:'9'">留存</th>
                <th data-options="field:'10'">消耗</th>
                <th data-options="field:'11'">总产出</th>
                <th data-options="field:'12'">留存</th>
                <th data-options="field:'13'">消耗</th>
                <th data-options="field:'14'">总产出</th>
                <th data-options="field:'15'">留存</th>
                <th data-options="field:'16'">消耗</th>
                <th data-options="field:'17'">总产出</th>
                <th data-options="field:'18'">留存</th>
                <th data-options="field:'19'">消耗</th>
                <th data-options="field:'20'">总产出</th>
                <th data-options="field:'21'">留存</th>
                <th data-options="field:'22'">消耗</th>
                <th data-options="field:'23'">总产出</th>
                <th data-options="field:'24'">留存</th>
                <th data-options="field:'25'">消耗</th>
                <th data-options="field:'26'">总产出</th>
                <th data-options="field:'27'">留存</th>
                <th data-options="field:'28'">消耗</th>
                <th data-options="field:'29'">总产出</th>
                <th data-options="field:'30'">留存</th>
            </tr>
        </thead>
    </table>
