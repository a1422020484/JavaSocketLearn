...
<div id="body2" 
    ...
    <div id="tb" style="padding:2px 5px;">
    	...
    	第三方订单ID:
        <input name="thirdId" id="thirdId" class="easyui-textbox" data-options="iconCls:'null'"   style="width:150px">
    	
    	订单ID:
        <input name="orderId" id="orderId" class="easyui-textbox" data-options="iconCls:'null'"   style="width:150px">
        
		玩家账号:
        <input name="accountId" id="accountId" class="easyui-textbox" data-options="iconCls:'null'"   style="width:150px">
	...
	function toSubmit() {
		...
		var thirdId = $('#thirdId').textbox('getValue');
		var orderId = $('#orderId').textbox('getValue');
		var accountId = $('#accountId').textbox('getValue');
		var playerName = $('#playerName').textbox('getValue');
		var startTime = $('#startTime').datebox('getValue');
		var endTime = $('#endTime').datebox('getValue');
		
		// 通过 ajax 请求数据
		var urlStr = "${sendUrl}&srvId="+ srvId + "&thirdId=" + thirdId+ "&orderId=" +orderId+ "&accountId=" + accountId+ "&playerName=" + playerName 
