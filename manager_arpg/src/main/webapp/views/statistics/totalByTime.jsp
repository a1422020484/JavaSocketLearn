...
<script type="text/javascript">
	function toCheck(startTime, endTime) {
		var retStr = callJava("${sendUrl}&startTime=" + startTime + "&endTime=" + endTime
				+ "&isSelect=1");
...
<body>
	...
	function toSubmit() {
		...
		// 通过 ajax 请求数据
		var urlStr = "${sendUrl}&startTime=" + startTime + "&endTime=" + endTime
				+ "&isSelect=1";
