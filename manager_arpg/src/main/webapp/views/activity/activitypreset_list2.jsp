...
<body>
	...
	<tr>
	<td>
	<label class="laber_from"  style="width:80px"> 请选择服务器 </label>
	 <select name="srvId" id="srvId" style="width:100px">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#dg').datagrid({url: 'listJsonByServer?srvId=-1'});
	});
	
	function onCheck()
	{
		var srvId = $("#srvId").val();
		$('#dg').datagrid({url: 'listJsonByServer?srvId=' + srvId});
	}
