...
<body>
    ...
    <div id="ft" style="padding:2px 5px;">
        <a href="javascript:void;" class="easyui-linkbutton l-btn-left l-btn-icon-left" iconCls="icon-save" plain="true" onclick="toExport()">导出excel</a>
   	</div>
    <div class="easyui-panel" title="平台操作日志" style="width:100%;height:500px;" data-options="footer:'#ft',tools:'#t1'">
    <div id="tt" class="easyui-tabs datagrid-view" style="width:100%;height:100%">
        <div title="邮件操作" style="padding:10px">
        ...
        <div title="GM指令" style="padding:10px">
        ...
        <div title="虚拟支付" style="padding:10px">
