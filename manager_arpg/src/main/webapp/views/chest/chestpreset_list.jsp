...
<body>
	<table id="searchTable" style="width: 98%">
		...
		<tr>
			...
			<th w_index="chestName" width="5%;">名称</th>
			<th w_index="remark" width="5%;">描述</th>
			<th w_render="operate" width="5%;">
			<a href="javascript:void;" target="_top" onclick="center_iframe('${sendUrl}?mainView=true');">发送</a> &nbsp;|&nbsp
