...
@Component
public class SystemLogClock extends zyt.spring.component.resource.Resource {
	protected static Map<String, String> map;
	protected static List<String> keys;

	public SystemLogClock() {
		super();
		this.reload();
	}
	...
	protected void reload(InputStream is) throws Exception {
		...
		SystemLogClock.map = Collections.unmodifiableMap(map);
		SystemLogClock.keys = Collections.unmodifiableList(new ArrayList<>(map.keySet()));
	}

	@Override
	public String getResourceFile() {
		// return "/config.properties";
		return "//resource/systemLogClock.json";
	}
